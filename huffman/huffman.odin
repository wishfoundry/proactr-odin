...
// huffman.encode / huffman.decode / huffman.TABLE.
...
// high `nbits` bits of a u32.
// decode uses a 256-state × 16-nybble FSM (see decode_table.odin, generated by
// gen_decode_table.py from TABLE). decode_slow retains the original linear
// bit-walk for tests / cross-check.
package huffman
