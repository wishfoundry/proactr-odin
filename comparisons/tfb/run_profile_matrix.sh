...

{
  ...
  echo "  drogon_oha_size: Size/request often WRONG on large bodies; body re-check is source of truth"
  echo "  ranking_rule: split ranks by mechanism; compare kernel_writev vs multi_send only when both measured"
